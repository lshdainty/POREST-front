        ...
        <div className='flex flex-col items-center text-center p-6'>
          ...
          <div className='w-full text-left space-y-5 text-sm'>
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>아이디</span>
              <div className="flex-grow">
                <Input value={editedUser.user_id} disabled className="w-full" />
              </div>
            </div>
            <div className='flex items-center'>
              <Mail className='mr-3 h-4 w-4 text-muted-foreground' />
              <span className='font-semibold w-24 mr-3'>이메일</span>
              <div className="flex-grow">
            ...
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>생년월일</span>
              <div className="flex-grow">
                <InputDatePicker
            ...
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>회사</span>
              <div className="flex-grow">
                <Select value={editedUser.user_company_name} onValueChange={(value) => handleInputChange('user_company_name', value)}>
            ...
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>부서</span>
              <div className="flex-grow">
                <Select value={editedUser.user_department_name} onValueChange={(value) => handleInputChange('user_department_name', value)}>
                  <SelectTrigger className="w-full">
            ...
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>유연근무시간</span>
              <div className="flex-grow">
            ...
            <div className='flex items-center'>
              ...
              <span className='font-semibold w-24 mr-3'>권한</span>
              <div className="flex-grow">
                <Select value={editedUser.user_role_type} onValueChange={(value) => handleInputChange('user_role_type', value)}>
                  <SelectTrigger className={cn("w-full", selectedRole?.className)}>
