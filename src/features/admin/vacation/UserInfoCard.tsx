    ...
    <div className='flex flex-col gap-6 h-full'>
      <Card className='h-full min-w-[350px]'>
        ...
        <CardContent className='flex flex-col items-center text-center p-6'>
          ...
          <p className='text-sm text-muted-foreground'>{displayUser.user_company_name} / {displayUser.user_department_name}</p>
          ...
          <div className='w-full text-left space-y-5 text-sm'>
            ...
            <div className='flex items-center'>
              ...
              <div className={cn(
                ...
                {displayUser.user_role_type === 'ADMIN' ? <UserRoundCog size={16}/> : <UserRound size={16}/>}
